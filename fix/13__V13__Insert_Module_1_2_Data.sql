...
(SELECT country_id FROM countries WHERE country_code = '+1' LIMIT 1), 'https://i.pravatar.cc/150?u=emily'),

('Guide', 'Anh', 'Nguyen', 'anh.nguyen@fellow4u.com', '$2a$12$obyHHLqZ1.98KEZjg8ZSZ.Q/W710jX8.dm7UxWL4BmhZhDVdI85li',
(SELECT country_id FROM countries WHERE country_code = '+84' LIMIT 1), 'https://thanhnien.mediacdn.vn/Uploaded/ngocthanh/2016_03_23/9x01_YGEO.jpg?width=500'),

('Guide', 'Ji-won', 'Park', 'jiwon.park@fellow4u.com', '$2a$12$obyHHLqZ1.98KEZjg8ZSZ.Q/W710jX8.dm7UxWL4BmhZhDVdI85li',
(SELECT country_id FROM countries WHERE country_code = '+82' LIMIT 1), 'https://www.paratime.vn/wp-content/uploads/2019/09/timestudio.vn-headshot-eye-glasses-02.jpg'),

('Traveler', 'Minh', 'Tran', 'minh.tran@example.com', '$2a$12$obyHHLqZ1.98KEZjg8ZSZ.Q/W710jX8.dm7UxWL4BmhZhDVdI85li',
(SELECT country_id FROM countries WHERE country_code = '+84' LIMIT 1), 'https://i.pravatar.cc/150?u=minh')
...
('Da Nang - Hoi An 3 Days Adventure', (SELECT location_id FROM locations WHERE city_name = 'Da Nang'), 150.00, 3, TRUE,
'https://ohdidi.vn/uploads/static/NEWS/blog/du%20lich%20da%20nang%20hoi%20an/du_lich_da_nang_hoi_an_2.png'),

('Explore Seoul Like a Local', (SELECT location_id FROM locations WHERE city_name = 'Seoul'), 299.00, 5, TRUE,
'https://www.agoda.com/wp-content/uploads/2024/04/Featured-image-Han-River-at-night-in-Seoul-South-Korea.jpg'),

('Street Food Paradise in Saigon', (SELECT location_id FROM locations WHERE city_name = 'Ho Chi Minh City'), 80.00, 1, FALSE,
...
((SELECT user_id FROM users WHERE email = 'anh.nguyen@fellow4u.com'), 'Morning Coffee & Dragon Bridge Walk', (SELECT location_id FROM locations WHERE city_name = 'Da Nang'), 15.00, 2.5,
'https://images2.thanhnien.vn/528068263637045248/2025/6/18/the-legend-danang-1-17502421275011965589401.jpg'),

((SELECT user_id FROM users WHERE email = 'jiwon.park@fellow4u.com'), 'Han River Night Picnic with Chimaek', (SELECT location_id FROM locations WHERE city_name = 'Seoul'), 35.00, 3.0,
